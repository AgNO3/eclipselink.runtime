...
/**
 * <p>
 * <b>Purpose</b>: A wrapper class for handling cases when the domain object attributes are to be accessed thru the
 * accessor methods. This could happen if the variables are not defined public in the domain object.
 * 
 * @author Sati
...
public class MethodAttributeAccessor extends AttributeAccessor {
    ...
    protected boolean delayedSetMethod;
            ...
            if ( PrivilegedAccessHelper.shouldUsePrivilegedAccess() ) {
                try {
                    ...
                    if ( throwableException instanceof IllegalAccessException ) {
                        ...
                        throw DescriptorException.targetInvocationWhileGettingValueThruMethodAccessor(getGetMethodName(), anObject.getClass()
                                .getName(), throwableException);
                    }
                }
            }
            else {
    ...
    public Class getGetMethodReturnType () throws DescriptorException {
        ...
        if ( null == getGetMethod() && null != getGetMethodName() && ( getGetMethodName().indexOf(Helper.PERSISTENCE_FIELDNAME_PREFIX) > -1 ) ) {
            ...
            throw DescriptorException.nullPointerWhileGettingValueThruMethodAccessorCausedByWeavingNotOccurringBecauseOfModuleOrder(
                getGetMethodName(),
                "",
                null);
        }
    ...
    protected void initializeAttributes ( Class theJavaClass, Class[] getParameterTypes ) throws DescriptorException {
        ...
        try {
            ...
            DescriptorException descriptorException = DescriptorException.noSuchMethodWhileInitializingAttributesInMethodAccessor(
                getSetMethodName(),
                getGetMethodName(),
                theJavaClass.getName());
            ...
            try {
                ...
                if ( fieldClass.isPrimitive() && ( attributeValue == null ) ) {
                    ...
                    if ( PrivilegedAccessHelper.shouldUsePrivilegedAccess() ) {
                        ...
                        PrivilegedAccessHelper.invokeMethod(overrideSetMethod, domainObject, parameters);
                    }
                }
                else {
                    // Some JVM's throw this exception for some very odd reason
